...
function LoginForm() {
  ...
  return (
    <div className={styles.authContainer}>
      <div style={{ position: 'absolute', top: '20px', right: '20px', display: 'flex', alignItems: 'center', gap: '8px', background: 'var(--subtle-bg)', padding: '6px 12px', borderRadius: '20px' }}>
      ...
      <div className={`glass-panel animate-fade-in ${styles.authBox}`}>
        ...
        <div className={styles.authFooter}>
          ...
          <div style={{ marginTop: '10px' }}>
            <a href="https://wa.me/60186647872" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'var(--subtle-bg)', padding: '10px 20px', borderRadius: '24px', fontSize: '0.85rem', color: 'var(--foreground)', border: '1px solid var(--subtle-border)' }}>
